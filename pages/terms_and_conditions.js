        ...
        <div class="page mb-32">
          ...
          <div class="translations-content-container">
              ...
              >
                ...
                <h1 className="text-black">Interpretation and Definitions</h1>
                ...
                <h1 className="text-black">Acknowledgment</h1>
                <p>
                ...
                <h1 className="text-black">Termination</h1>
                <p>
                ...
                <h1 className="text-black">Limitation of Liability</h1>
                <p>
                ...
                <h1 className="text-black">Governing Law</h1>
                <p>
                ...
                <h1 className="text-black">Severability and Waiver</h1>
                <h2>Severability</h2>
                <p>
                ...
                <h1 className="text-black">Translation Interpretation</h1>
                <p>
                ...
                <h1 className="text-black">Changes to These Terms and Conditions</h1>
                <p>
                ...
                <ul>
                  <li>By email: contactmtsschool@gmail.com</li>
                </ul>
              </div>
            </div>
          </div>
