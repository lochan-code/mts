...
const privacy_policy = () => {
  ...
  <div className="header">
      <p className="title">Privacy Policy for MTS School</p>
  </div>
  <div className="translations-content-container">
      <div className="tab-content translations-content-item en visible" id="en">
        ...
        <h1 className="text-black">Collecting and Using Your Personal Data</h1>
        ...
        <h1 className="text-black">Changes to this Privacy Policy</h1>
        <p>
